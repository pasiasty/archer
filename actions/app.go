...
func App() *buffalo.App {
	if app == nil {
		...
		app.POST("/game/move", GameMove)
		app.POST("/game/shoot", GameShoot)
		app.POST("/game/get_trajectory", GameGetTrajectory)
		app.POST("/preparation/game_settings", PreparationGameSettings)
